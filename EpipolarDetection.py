...
class EpipolarGeometry: 
    def __init__(self,showImages): 
        ...
        #loads images
        root = os.getcwd()
        imgLeftPath = os.path.join(root,'/home/sebastienphilo/StereomatchingAttempt1/aloeL.jpg')
        imgRightPath = os.path.join(root,'/home/sebastienphilo/StereomatchingAttempt1/aloeR.jpg')
